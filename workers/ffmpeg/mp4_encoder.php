 ...
 * LETS ENCODE!!!!
 */
if(preg_match('/enable-libx264/', $ffmpeg_config) > 0){
	/*
	 * Will use libx264 (preferred)
	 */

}else{
	/*
	 * Will try and get next best thing from libavcodec
	 */
	// -r 65535/2733
	// -r 30000/1001 -qscale 5 -ac 2 -ar 48000 -ab 192k
	$command = "ffmpeg -i $input_file_name -s 640:480 -aspect 4:3 -r 100 -qscale 5 -b 300k -bt 300k -ac 2 -ar 48000 -ab 192k -y $output_temp_file 2>&1";
